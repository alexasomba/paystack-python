...
split_fetch_response_data_instance = SplitFetchResponseData.from_json(json)
# print the JSON string representation of the object
print SplitFetchResponseData.to_json()

# convert the object into a dict
split_fetch_response_data_dict = split_fetch_response_data_instance.to_dict()
# create an instance of SplitFetchResponseData from a dict
split_fetch_response_data_form_dict = split_fetch_response_data.from_dict(split_fetch_response_data_dict)
```
