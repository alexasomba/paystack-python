...
virtual_terminal_delete_split_code_response_instance = VirtualTerminalDeleteSplitCodeResponse.from_json(json)
# print the JSON string representation of the object
print VirtualTerminalDeleteSplitCodeResponse.to_json()

# convert the object into a dict
virtual_terminal_delete_split_code_response_dict = virtual_terminal_delete_split_code_response_instance.to_dict()
