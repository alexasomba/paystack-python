...
virtual_terminal_add_split_code_instance = VirtualTerminalAddSplitCode.from_json(json)
# print the JSON string representation of the object
print VirtualTerminalAddSplitCode.to_json()

# convert the object into a dict
virtual_terminal_add_split_code_dict = virtual_terminal_add_split_code_instance.to_dict()
