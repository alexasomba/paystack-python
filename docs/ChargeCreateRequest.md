...
charge_create_request_instance = ChargeCreateRequest.from_json(json)
# print the JSON string representation of the object
print ChargeCreateRequest.to_json()

# convert the object into a dict
charge_create_request_dict = charge_create_request_instance.to_dict()
# create an instance of ChargeCreateRequest from a dict
charge_create_request_form_dict = charge_create_request.from_dict(charge_create_request_dict)
```
