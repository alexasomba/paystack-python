...
virtual_terminal_create_response_data_destinations_inner_instance = VirtualTerminalCreateResponseDataDestinationsInner.from_json(json)
# print the JSON string representation of the object
print VirtualTerminalCreateResponseDataDestinationsInner.to_json()

# convert the object into a dict
virtual_terminal_create_response_data_destinations_inner_dict = virtual_terminal_create_response_data_destinations_inner_instance.to_dict()
