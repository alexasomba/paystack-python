...
class BankApi:
    ...
    def _bank_list_serialize(
        ...
        if pay_with_bank is not None:
            ...
            _query_params.append(('pay_with_bank', pay_with_bank))
            
        if enabled_for_verification is not None:
            
            _query_params.append(('enabled_for_verification', enabled_for_verification))
        ...
        if include_nip_sort_code is not None:
            ...
            _query_params.append(('include_nip_sort_code', include_nip_sort_code))
    ...
    def bank_resolve_account_number_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VerificationResolveAccountNumberResponse]:
        """Resolve Account Number
    ...
    def bank_validate_account_number_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VerificationValidateAccountResponse]:
        """Validate Bank Account
    ...
    def _bank_validate_account_number_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if bank_validate_request is not None:
            _body_params = bank_validate_request
