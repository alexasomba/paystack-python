...
class PreAuthorizationCaptureResponseDataSplit(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "bearer_type", "subaccounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PreAuthorizationCaptureResponseDataSplit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PreAuthorizationCaptureResponseDataSplit from a dict"""
        if obj is None:
            return None
