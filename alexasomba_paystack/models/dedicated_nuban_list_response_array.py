...
class DedicatedNubanListResponseArray(BaseModel):
    ...
    currency: StrictStr
    split_config: Optional[DedicatedNubanListResponseArraySplitConfig]
    active: StrictBool
    assigned: StrictBool
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customer": DedicatedNubanListResponseArrayCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            ...
            "split_config": DedicatedNubanListResponseArraySplitConfig.from_dict(obj["split_config"]) if obj.get("split_config") is not None else None,
