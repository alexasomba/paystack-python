...
class PlanUpdate(BaseModel):
    ...
    amount: Optional[StrictInt] = Field(default=None, description="Amount should be in the subunit of the supported currency (e.g. kobo for NGN, pesewas for GHS, cents for ZAR/USD/KES). For XOF, send the amount multiplied by 100 even though the currency does not use fractional subunits.")
    ...
    metadata: Optional[SubaccountUpdateMetadata] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "amount", "interval", "description", "metadata", "send_invoices", "send_sms", "currency", "invoice_limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": SubaccountUpdateMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
