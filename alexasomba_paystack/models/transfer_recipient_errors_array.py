...
class TransferRecipientErrorsArray(BaseModel):
    ...
    """ # noqa: E501
    message: StrictStr
    records: List[ErrorRecordsArray]
    __properties: ClassVar[List[str]] = ["message", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [ErrorRecordsArray.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
