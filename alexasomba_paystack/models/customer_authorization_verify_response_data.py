...
class CustomerAuthorizationVerifyResponseData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["authorization_code", "channel", "bank", "active", "customer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer": CustomerAuthorizationVerifyResponseCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None
        })
        return _obj
