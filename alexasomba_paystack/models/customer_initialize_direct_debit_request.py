...
class CustomerInitializeDirectDebitRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "account": CustomerInitializeDirectDebitAccount.from_dict(obj["account"]) if obj.get("account") is not None else None,
            "address": CustomerInitializeDirectDebitAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
