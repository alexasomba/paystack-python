...
class SubaccountUpdate(BaseModel):
    ...
    percentage_charge: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The percentage the main account receives from each payment made to the subaccount")
