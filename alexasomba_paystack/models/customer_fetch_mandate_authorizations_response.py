...
class CustomerFetchMandateAuthorizationsResponse(BaseModel):
    ...
    status: StrictBool
    message: StrictStr
    data: List[CustomerFetchMandateAuthorizationsResponseData]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CustomerFetchMandateAuthorizationsResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": CustomerFetchMandateAuthorizationsResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
