...
class PaymentRequestFinalizeResponseData(BaseModel):
    ...
    discount: Optional[PaymentRequestFinalizeResponseDataDiscount] = None
    split_code: Optional[StrictStr] = None
    pending_amount: StrictInt
    __properties: ClassVar[List[str]] = ["id", "domain", "amount", "currency", "due_date", "has_invoice", "invoice_number", "description", "pdf_url", "line_items", "tax", "request_code", "status", "paid", "paid_at", "metadata", "notifications", "offline_reference", "customer", "created_at", "discount", "split_code", "pending_amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discount": PaymentRequestFinalizeResponseDataDiscount.from_dict(obj["discount"]) if obj.get("discount") is not None else None,
